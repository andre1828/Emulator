class Cache 
	...
	def initialize 
		@cache = [{:instruction=>[:add, :A, :B], :time=>691799064}, {:instruction=>[:add, :B, :C], :time=>691902956}, {:instruction=>[:add, :A, :B], :time=>691993669}, {:instruction=>[:add, :A, :B], :time=>692089209}, {:instruction=>[:add, :A, :B], :time=>692191623}] #[[11, 1010, 1011], [11, 1011, 1100], [11, 1010, 1011], [11, 1010, 1011], [11, 1010, 1011]]
